...
const getUsers = () => {
  API.getUsers().then(results => {
    ...
    for (i=0; i < data.length; i++) {
      console.log(results.data.results[i].cell)
      console.log(results.data.results[i].email)
      console.log(results.data.results[i].name.first + " " + results.data.results[i].name.last )
